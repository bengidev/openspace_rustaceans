...
pub enum ToolErrorKind {
    ...
    /// broken pipe, …).
    Io,
    /// The underlying operation reported an authorization or permission denial.
    PermissionDenied,
...
// ─────────────────────────────────────────────────────────────────────
// Retry classification — small, runtime-agnostic primitives the agent
// loop can apply before later tool execution orchestration lands.
// ─────────────────────────────────────────────────────────────────────
