...
//!   `OpenAiCompatibleProvider::aggregator` constructor consumes.
//!
//! Only [`OpenAiCompatibleProvider`] and [`AttributionMode`] are
//! re-exported from the crate root; the supporting modules are
...
pub use aggregator::AttributionMode;
